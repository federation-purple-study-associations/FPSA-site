<template scoped>
  <el-header class="header">
    ...
    <el-menu mode="horizontal" class="header-navigation" :default-active="window.location.pathname" router>
      ...
      <el-popover placement="bottom" width="160" trigger="hover" class="login-menu" v-if="!isLoggedIn">
      ...
      <el-menu-item index="/admin" v-if="isLoggedIn"><i class="el-icon-user"></i></el-menu-item>
    </el-menu>
  </el-header>
</template>
