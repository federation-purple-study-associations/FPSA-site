...
export class BoardService {
     ...
     */
    public boardCreate(titleNL: string, titleEN: string, textNL: string, textEN: string, image?: Blob, policy?: Blob, observe?: 'body', headers?: Headers): Observable<any>;
    public boardCreate(titleNL: string, titleEN: string, textNL: string, textEN: string, image?: Blob, policy?: Blob, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public boardCreate(titleNL: string, titleEN: string, textNL: string, textEN: string, image?: Blob, policy?: Blob, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (policy !== undefined) {
            formData.append('policy', <any>policy);
        }
     ...
     */
    public boardGetPhoto(id: number, observe?: 'body', headers?: Headers): Observable<any>;
    public boardGetPhoto(id: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    ...
    /**
     * getPolicy
     * This call can be used to get the policy plan of the specific board
     * @param id 
     
     */
    public boardGetPolicy(id: number, observe?: 'body', headers?: Headers): Observable<any>;
    public boardGetPolicy(id: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public boardGetPolicy(id: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
            throw new Error('Required parameter id was null or undefined when calling boardGetPolicy.');
        }
     ...
     */
    public boardpdate(id: number, titleNL: string, titleEN: string, textNL: string, textEN: string, image?: Blob, policy?: Blob, observe?: 'body', headers?: Headers): Observable<any>;
    public boardpdate(id: number, titleNL: string, titleEN: string, textNL: string, textEN: string, image?: Blob, policy?: Blob, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public boardpdate(id: number, titleNL: string, titleEN: string, textNL: string, textEN: string, image?: Blob, policy?: Blob, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
